...
\contentsline {lstlisting}{\numberline {4.3}Simplified VC for the Requires Clause of Advance}{35}{lstlisting.4.3}
\contentsline {lstlisting}{\numberline {4.4}A VC for which strenthening the consequent is useful}{37}{lstlisting.4.4}
\contentsline {lstlisting}{\numberline {4.5}An example of prover output from a Queue reversal operation (antecedents have been omitted for brevity))}{43}{lstlisting.4.5}
\contentsline {lstlisting}{\numberline {6.1}The specification of \texttt {Adding\_Capabilitiy} and \texttt {Multiplying\_Capability}}{77}{lstlisting.6.1}
\contentsline {lstlisting}{\numberline {6.2}A recursive implementation of \texttt {Adding\_Capability}}{78}{lstlisting.6.2}
\contentsline {lstlisting}{\numberline {6.3}An iterative implementation of \texttt {Multiplying\_Capability}}{79}{lstlisting.6.3}
\contentsline {lstlisting}{\numberline {6.4}The specification of \texttt {Searching\_Capabilitiy}}{80}{lstlisting.6.4}
\contentsline {lstlisting}{\numberline {6.5}An implementation of \texttt {Searching\_Capabilitiy}}{82}{lstlisting.6.5}
\contentsline {lstlisting}{\numberline {6.6}A snippet of the specification of arrays}{83}{lstlisting.6.6}
\contentsline {lstlisting}{\numberline {6.7}A problematic VC}{83}{lstlisting.6.7}
\contentsline {lstlisting}{\numberline {6.8}New givens after replacing \texttt {A''} with \texttt {A}}{84}{lstlisting.6.8}
\contentsline {lstlisting}{\numberline {6.9}New goal after expanding \texttt {A'}}{84}{lstlisting.6.9}
\contentsline {lstlisting}{\numberline {6.10}New goal after expanding \texttt {key}}{85}{lstlisting.6.10}
\contentsline {lstlisting}{\numberline {6.11}A useful theorem about lambda expressions}{85}{lstlisting.6.11}
\contentsline {lstlisting}{\numberline {6.12}The specification of \texttt {Sorting\_Capability}}{86}{lstlisting.6.12}
\contentsline {lstlisting}{\numberline {6.13}A selection sort realization of \texttt {Sorting\_Capabilitiy}}{87}{lstlisting.6.13}
\contentsline {lstlisting}{\numberline {6.14}The specification of \texttt {Flipping\_Capabilitiy}}{89}{lstlisting.6.14}
