...
%  ===========================================================================
    ...
    \inputfile{proverEval/proverEvaluation}
    \inputfile{mathEval/mathSystemEvaluation}
...
\lstset{breaklines=true}
	\begin{appendices}
		\begin{subappendices}
			\inputfile{appendices/a.tex}
			\inputfile{appendices/b.tex}
			\inputfile{appendices/c.tex}
			\inputfile{appendices/d.tex}
		\end{subappendices}
	\end{appendices}
    ...
    \addtotoc{Bibliography}{\bibliography{dissertation}}
\end{document}
